...
class ArrayTypeTest extends TestCase
{
     ...
     * @test
     */
    public function array_types_are_named_array(): void
    {
     ...
     * @test
     */
    public function array_types_use_their_name_when_cast_to_a_string(): void
    {
        $this->assertEquals('array', (string)$this->type);
    }
     ...
     * @test
     */
    public function array_types_are_primitive(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_scalar(): void
    {
     ...
     * @test
     */
    public function array_types_are_compound(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_special(): void
    {
     ...
     * @test
     */
    public function array_types_can_be_parameter_types(): void
    {
     ...
     * @test
     */
    public function array_types_can_be_property_types(): void
    {
     ...
     * @test
     */
    public function array_types_can_be_return_types(): void
    {
    ...
    {
        $this->assertTrue($this->type->isAssignableTo('array'));
    }
     ...
     * @test
     */
    public function array_types_are_not_assignable_to_scalar_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_to_other_compound_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_to_special_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_to_classes(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_to_stringable_classes(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_to_traversable_classes(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_from_scalar_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_from_other_compound_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_from_special_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_from_classes(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_from_stringable_classes(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_assignable_from_traversable_classes(): void
    {
     ...
     * @test
     */
    public function array_types_are_of_type_array(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_of_scalar_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_of_other_compound_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_of_special_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_of_class_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_of_stringable_class_types(): void
    {
     ...
     * @test
     */
    public function array_types_are_not_of_traversable_class_types(): void
    {
    ...
    {
        $this->assertFalse($this->type->isAlias());
    }

    /**
     * @test
     */
    public function array_types_are_children_of_iterable(): void
    {
        $this->assertInstanceOf(ChildType::class, $this->type);
        $this->assertInstanceOf(IterableType::class, $this->type->getParentType());
        $this->assertEquals('iterable', $this->type->getParentType()->getName());
    }
}