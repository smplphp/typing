...
use Smpl\Typing\Tests\Fixtures\InvokableClass;
...
class CallableTypeTest extends TestCase
{
     ...
     * @test
     */
    public function callable_types_use_their_name_when_cast_to_a_string(): void
    {
        $this->assertEquals('callable', (string)$this->type);
    }

    /**
     * @test
     */
    public function callable_types_are_native(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_nullable(): void
    {
     ...
     * @test
     */
    public function callable_types_are_primitive(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_scalar(): void
    {
     ...
     * @test
     */
    public function callable_types_are_compound(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_special(): void
    {
     ...
     * @test
     */
    public function callable_types_are_builtin(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_internal(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_user_defined(): void
    {
     ...
     * @test
     */
    public function callable_types_are_standalone_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_native_standalone_types(): void
    {
     ...
     * @test
     */
    public function callable_types_can_be_parameter_types(): void
    {
     ...
     * @test
     */
    public function callable_types_can_not_be_property_types(): void
    {
        $this->assertFalse($this->type->isPropertyType());
    }

    /**
     * @test
     */
    public function callable_types_can_not_be_return_types(): void
    {
        $this->assertFalse($this->type->isReturnType());
    }

    /**
     * @test
     */
    public function callable_types_are_assignable_to_callable_types(): void
    {
        $this->assertTrue($this->type->isAssignableTo('callable'));
    }

    /**
     * @test
     */
    public function callable_types_are_not_assignable_to_scalar_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_to_other_compound_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_to_special_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_to_classes(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_to_invokable_classes(): void
    {
        $this->assertFalse($this->type->isAssignableTo(InvokableClass::class));
    }

    /**
     * @test
     */
    public function callable_types_are_not_assignable_to_stringable_classes(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_to_traversable_classes(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_to_closures(): void
    {
        $this->assertFalse($this->type->isAssignableTo(Closure::class));
    }

    /**
     * @test
     */
    public function callable_types_are_assignable_from_callable_types(): void
    {
        $this->assertTrue($this->type->isAssignableFrom('callable'));
    }

    /**
     * @test
     */
    public function callable_types_are_not_assignable_from_scalar_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_from_other_compound_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_from_special_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_from_classes(): void
    {
     ...
     * @test
     */
    public function callable_types_are_assignable_from_invokable_classes(): void
    {
        $this->assertTrue($this->type->isAssignableFrom(InvokableClass::class));
    }

    /**
     * @test
     */
    public function callable_types_are_not_assignable_from_stringable_classes(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_from_traversable_classes(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_assignable_from_closures(): void
    {
        $this->assertTrue($this->type->isAssignableFrom(Closure::class));
    }

    /**
     * @test
     */
    public function callable_types_are_of_type_callable(): void
    {
        $this->assertTrue($this->type->isOfType(new InvokableClass()));
        $this->assertTrue($this->type->isOfType(fn() => false));
        $this->assertTrue($this->type->isOfType([Types::class, 'getInstance']));
        $this->assertTrue($this->type->isOfType(Types::getInstance(...)));
    }

    /**
     * @test
     */
    public function callable_types_are_not_of_scalar_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_of_other_compound_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_of_special_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_of_class_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_of_stringable_class_types(): void
    {
     ...
     * @test
     */
    public function callable_types_are_not_of_traversable_class_types(): void
    {
