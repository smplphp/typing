...
class StringTypeTest extends TestCase
{
     ...
     * @test
     */
    public function string_types_are_named_string(): void
    {
     ...
     * @test
     */
    public function string_types_use_their_name_when_cast_to_a_string(): void
    {
        $this->assertEquals('string', (string)$this->type);
    }
     ...
     * @test
     */
    public function string_types_are_primitive(): void
    {
     ...
     * @test
     */
    public function string_types_are_scalar(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_compound(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_special(): void
    {
     ...
     * @test
     */
    public function string_types_can_be_parameter_types(): void
    {
     ...
     * @test
     */
    public function string_types_can_be_property_types(): void
    {
     ...
     * @test
     */
    public function string_types_can_be_return_types(): void
    {
    ...
    {
        $this->assertTrue($this->type->isAssignableTo('string'));
    }

    /**
     * @test
     */
    public function string_types_are_not_assignable_to_other_scalar_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_to_compound_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_to_special_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_to_classes(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_to_stringable_classes(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_to_traversable_classes(): void
    {
    ...
    {
        $this->assertTrue($this->type->isAssignableFrom('string'));
    }

    /**
     * @test
     */
    public function string_types_are_not_assignable_from_other_scalar_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_from_compound_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_from_special_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_from_classes(): void
    {
     ...
     * @test
     */
    public function string_types_are_assignable_from_stringable_classes(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_assignable_from_traversable_classes(): void
    {
     ...
     * @test
     */
    public function string_types_are_of_type_string(): void
    {
        $this->assertTrue($this->type->isOfType('I am a string'));
    }

    /**
     * @test
     */
    public function string_types_are_not_of_other_scalar_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_of_compound_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_of_special_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_of_class_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_of_stringable_class_types(): void
    {
     ...
     * @test
     */
    public function string_types_are_not_of_traversable_class_types(): void
    {
